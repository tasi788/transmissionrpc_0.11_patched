...
class Client(object):
	...
	def add_torrent(self, torrent, timeout=None, **kwargs):
		...
		if parsed_uri.scheme in ['ftp', 'ftps', 'http', 'https']:
			...
			req = urllib.request.Request(torrent, headers={'User-Agent' : "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/59.0.3071.115 Safari/537.36"})
